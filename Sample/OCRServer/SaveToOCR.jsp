...
%><%
	...
	if (fileItem != null && strOutputFormat != null && strRequestBody != null) {
		...
		strRequestBody = strRequestBody.replace("#inputFile#", strInputFile.replaceAll("\\\\","\\\\\\\\"));
		...
		try {
			if(result){
				...
				strRequestBody = strRequestBody.replace("#outputFile#", outPutFile.replaceAll("\\\\","\\\\\\\\"));

				String strResponse = "";

				// upload
				strResponse = org.apache.http.client.fluent.Request.Post("http://127.0.0.1:18618/OCRPro")
						.useExpectContinue()
